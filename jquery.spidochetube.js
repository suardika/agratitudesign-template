...
(function($){
    ...
    $.fn.spidochetube = function(options){
        ...
        return this.each(function(){
            ...
            // Build the url
            url ="https://www.googleapis.com/youtube/v3/playlistItems?playlistId="+id+"&orderby=timePosition&pageToken="+next_page+"&maxResults="+max_results+"&key="+settings.key+"&part=snippet,status,contentDetails";
