 ...
 * URL: http://www.softglad.com/2013/08/json-search-box-for-blogger.html
 */
...
function showResult(json) {
	...
	skeleton += '<a class="closebtn" title="Close" href="#close" onclick="resultContainer.style.display=\'none\';return false;">&times;</a><ol>';
	if (entry === "") {
	...
	for (var i = 0; i < config.numPost; i++) {
		...
		skeleton += '<li><img style="width:'+config.thumbSize+'px;height:'+config.thumbSize+'px;" src="'+img+'" alt="" /><p><a href="'+url+'" target="_blank">'+title+'</a>'+summary+'</p></li>';
	}
	skeleton += '</ol>';
